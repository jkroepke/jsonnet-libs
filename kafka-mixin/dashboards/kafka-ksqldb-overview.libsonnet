...

{
  local commonvars = var.new(
    ...
    filteringSelector=$._config.ksqldbFilteringSelector,
    groupLabels=$._config.groupLabels,
    instanceLabels=$._config.instanceLabels,
  ),
  grafanaDashboards+::
    {
      'ksqldb-overview.json':
...

        {
          ...
          panels: [
            ...
            },
            {
              ...
              targets: [
                {
                  expr: 'irate(process_cpu_seconds_total{' + commonvars.queriesSelector + '}[$__rate_interval])',
                  interval: '',
                  legendFormat: utils.labelsToPanelLegend($._config.instanceLabels),
                  refId: 'A',
                },
            ...
            },
            {
              ...
              targets: [
                ...
                {
                  expr: 'jvm_memory_bytes_max{area="heap", ' + commonvars.queriesSelector + '}',
                  interval: '',
