...

{
  local commonvars = var.new(
    ...
    filteringSelector=$._config.zookeeperFilteringSelector,
              ...
              targets: [
                {
                  ...
                  interval: '',
                  legendFormat: '{{server_name}}/' + utils.labelsToPanelLegend($._config.instanceLabels),
                  range: true,
                  refId: 'A',
                },
              ],
              ...
              targets: [
                {
                  ...
                  interval: '',
                  legendFormat: 'Used:' + utils.labelsToPanelLegend($._config.instanceLabels),
                  range: true,
                  refId: 'A',
                },
                {
                  ...
                  interval: '',
                  legendFormat: 'Max:' + utils.labelsToPanelLegend($._config.instanceLabels),
                  range: true,
                  refId: 'B',
                },
              ],
