...

{
  local commonvars = var.new(
    ...
    filteringSelector=$._config.kafkaConnectSelector,
          ...
          panels: [
              ...
              targets: [
                {
                  ...
                  interval: '',
                  legendFormat: '{{cluster}}/' + utils.labelsToPanelLegend($._config.instanceLabels),
                  refId: 'A',
                },
              ],
              thresholds: [],
            ...
            },
            {
              ...
              styles: [
                ...
                {
                  alias: 'Connector Startup Success Total',
                  align: 'auto',
                  colorMode: null,
                  colors: [
                    'rgba(245, 54, 54, 0.9)',
                ...
                {
                  alias: 'Connector Startup Failure Total',
                  align: 'auto',
                  colorMode: null,
                  colors: [
                    'rgba(245, 54, 54, 0.9)',
                ...
                {
                  alias: 'Average time of Rebalances',
                  align: 'auto',
                  colorMode: null,
                  colors: [
                    'rgba(245, 54, 54, 0.9)',
                ...
                {
                  alias: 'Time since last rebalance',
                  align: 'auto',
                  colorMode: null,
                  colors: [
                    'rgba(245, 54, 54, 0.9)',
              ...
              targets: [
                {
                  ...
                  interval: '',
                  intervalFactor: 1,
                  legendFormat: utils.labelsToPanelLegend($._config.instanceLabels) + '/{{client_id}}',
                  refId: 'A',
                },
              ],
              thresholds: [],
            ...
            },
            {
              ...
              scopedVars: {
                instance: {
                  selected: false,
                  text: '192.168.99.101:7005',
                  value: '192.168.99.101:7005',
                },
              },
              targets: [
                {
